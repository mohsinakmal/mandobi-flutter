...
class AgentProfileCreationTwo extends StatefulWidget {
  const AgentProfileCreationTwo({Key? key}) : super(key: key);

  @override
  State<AgentProfileCreationTwo> createState() => _AgentProfileCreationTwoState();
}

class _AgentProfileCreationTwoState extends State<AgentProfileCreationTwo> with TickerProviderStateMixin {
                                    ...
                                    Expanded(
                                      child: TextField(
                                        ...
                                        decoration:  InputDecoration(
                                          ...
                                          labelText: "Year From",
                                          labelStyle: TextStyle(color: ColorUtils.black.withOpacity(0.5)),
                                          suffixIcon: Padding(
                                            padding: EdgeInsets.only(right: 4.w),
